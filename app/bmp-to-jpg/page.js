...
const _FEATURES = [
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><rect x="2" y="2" width="9" height="9" rx="1"/><rect x="13" y="2" width="9" height="9" rx="1"/><rect x="2" y="13" width="9" height="9" rx="1"/><rect x="13" y="13" width="9" height="9" rx="1"/></svg>), title: 'Batch Convert', desc: 'Convert multiple BMP files at once.' },
...
const _STEPS = [
  { n: '1', title: 'Upload BMP', desc: 'Select your BMP image file.' },
...
export default function BmpToJpgPage() {
  ...
  const downloadJpgImage = () => {
    ...
    saveHistory('BMP to JPG Converter', newName);
  };
