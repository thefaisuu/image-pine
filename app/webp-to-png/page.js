...
const _FEATURES = [
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><path d="M8 3l4 4-4 4M16 21l-4-4 4-4"/><path d="M12 7H5a2 2 0 00-2 2v2M12 17h7a2 2 0 002-2v-2"/></svg>), title: 'Lossless PNG', desc: 'PNG preserves all detail and supports transparency.' },
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><rect x="2" y="2" width="9" height="9" rx="1"/><rect x="13" y="2" width="9" height="9" rx="1"/><rect x="2" y="13" width="9" height="9" rx="1"/><rect x="13" y="13" width="9" height="9" rx="1"/></svg>), title: 'Batch Convert', desc: 'Convert multiple WebP files to PNG.' },
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>), title: 'Full Transparency', desc: 'WebP alpha maps to PNG alpha channel.' }
];
...
export default function WebpToPngPage() {
  ...
  const downloadPngImage = () => {
    ...
    saveHistory('WebP to PNG Converter', newName);
  };
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. In the Advanced Options group, select 'Custom size' and enter custom dimensions."
    },
    {
      q: "Are my photos secure?",
      a: "Yes, conversions happen client-side in your browser. No data leaves your machine."
    }
  ];
  ...
  return (
    <ToolPageShell
      ...
      steps={_STEPS}
      faqs={_FAQS}
      seoText="Convert WebP to PNG online for free. Transform WebP to lossless PNG with transparency in your browser. No uploads."
    >
