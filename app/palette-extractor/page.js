...
const _FEATURES = [
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2C6.48 2 2 6.48 2 12C2 14.72 3.09 17.2 4.86 19C5.34 19.48 6.13 19.34 6.44 18.73C6.79 18.05 7.5 17.5 8.5 17.5H9.5C10.6 17.5 11.5 18.4 11.5 19.5V21.5C11.5 21.78 11.72 22 12 22Z"/><circle cx="7.5" cy="10.5" r="1.5" fill="currentColor"/><circle cx="11.5" cy="7.5" r="1.5" fill="currentColor"/><circle cx="16.5" cy="9.5" r="1.5" fill="currentColor"/><circle cx="15.5" cy="14.5" r="1.5" fill="currentColor"/></svg>), title: '6-Color Quantization', desc: 'Identify the 6 most prominent and visually distinct colors from any image.' },
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="8" y="2" width="8" height="4" rx="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="M9 14l2 2 4-4" /></svg>), title: 'One-Click Clipboard', desc: 'Instantly copy any color value directly to your clipboard in your preferred code format.' },
...
export default function PaletteExtractorPage() {
  ...
  const downloadPaletteCard = () => {
    ...
    ctx.textAlign = 'right';
    ctx.fillText('GENERATED BY IMAGEPINE', 570, 385);
