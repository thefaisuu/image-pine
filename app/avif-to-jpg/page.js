...
const _FEATURES = [
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><rect x="2" y="2" width="9" height="9" rx="1"/><rect x="13" y="2" width="9" height="9" rx="1"/><rect x="2" y="13" width="9" height="9" rx="1"/><rect x="13" y="13" width="9" height="9" rx="1"/></svg>), title: 'Batch Convert', desc: 'Convert multiple AVIF files at once.' },
...
const _STEPS = [
  { n: '1', title: 'Upload AVIF', desc: 'Select your AVIF image file.' },
...
export default function AvifToJpgPage() {
  ...
  useEffect(() => {
    ...
    img.onerror = () => {
      if (active) {
        setErrorMsg('Failed to process image source. Your browser might not support AVIF natively.');
        setIsConverting(false);
      }
    };
  ...
  const downloadJpgImage = () => {
    ...
    saveHistory('AVIF to JPG Converter', newName);
  };
