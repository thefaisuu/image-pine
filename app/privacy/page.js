      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }} className="animate-fade-in">
        ...
        <div style={cardStyle}>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginTop: 10 }}>
              As part of this protection, Cloudflare Turnstile may set cookies or use similar browser-local storage mechanisms to distinguish legitimate human users from automated traffic. These cookies are technical in nature and contain no personal information. Use of Cloudflare Turnstile is subject to the <a href="https://www.cloudflare.com/en-gb/turnstile-privacy-policy/" target="_blank" rel="noopener noreferrer" style={{ color: '#5B5BD6', fontWeight: 600, textDecoration: 'none' }}>Turnstile Privacy Addendum</a>.
            </p>
            <p style={{ ...pStyle, marginTop: 10 }}>
