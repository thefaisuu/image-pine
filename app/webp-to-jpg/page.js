...
const _FEATURES = [
  ...
  { icon: (<svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round"><rect x="2" y="2" width="9" height="9" rx="1"/><rect x="13" y="2" width="9" height="9" rx="1"/><rect x="2" y="13" width="9" height="9" rx="1"/><rect x="13" y="13" width="9" height="9" rx="1"/></svg>), title: 'Batch Convert', desc: 'Convert multiple WebP files at once.' },
...
export default function WebpToJpgPage() {
  ...
  const downloadJpgImage = () => {
    ...
    saveHistory('WebP to JPG Converter', newName);
  };
  ...
  const faqs = [
    {
      q: "Does JPEG support WebP transparency?",
      a: "No. The JPEG format does not support alpha transparency. Any transparent background in your WebP file will convert to solid white."
    },
    {
    ...
    {
      q: "Is resizing supported during conversion?",
  ...
  return (
    <ToolPageShell
      ...
      steps={_STEPS}
      faqs={_FAQS}
      seoText="Convert WebP to JPG online for free. Transform WebP to universally compatible JPEG in your browser. No uploads."
    >
