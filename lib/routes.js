...
export const navbarSections = {
  ...
  convert: {
    title: 'Convert',
    items: [
      'Image Converter', 'SVG Rasterizer', 
      'GIF Converter', 'HEIC to JPG', 'WebP to PNG', 'WebP to JPG', 
      'PNG to JPG', 'PNG to SVG', 'AVIF to JPG', 'BMP to JPG', 'TIFF to JPG'
    ]
  },
  pdf: {
    title: 'PDF Tools',
    items: ['Compress PDF', 'Image to PDF', 'PDF to Images', 'JPG to PDF', 'PNG to PDF', 'Add or Remove PDF Pages']
  },
  creative: {
    title: 'Creative',
    items: [
...
export const footerColumns = {
  ...
  convert: {
    title: 'Convert',
    items: [
      'Image Converter', 'PDF to JPG', 'HEIC to JPG', 'SVG Rasterizer', 
      'GIF Converter', 'PNG to SVG', 'WebP to JPG', 'PNG to JPG',
      'AVIF to JPG', 'BMP to JPG', 'TIFF to JPG'
    ]
  },
  pdfTools: {
    title: 'PDF Tools',
    items: [
      'Compress PDF', 'Image to PDF', 'PDF to Images', 'JPG to PDF', 'PNG to PDF', 
