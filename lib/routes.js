...
export const navbarSections = {
  ...
  more: {
    title: 'More Tools',
    items: [
      'Rotate Image', 'Flip Image', 'Collage Maker', 'EXIF Metadata Stripper', 
      'Photo Filters', 'Image Watermarker', 'SVG Rasterizer', 'GIF Maker',
      'Meme Generator', 'Palette Extractor', 'Image OCR Extractor', 'Drawing Markup', 'Bulk Renamer'
    ]
  }
};
...
export const footerColumns = {
  imageTools: {
    ...
    items: [
      ...
      'SVG Rasterizer', 'GIF Maker', 'Meme Generator', 'Palette Extractor',
      'Image OCR Extractor', 'Drawing Markup', 'Bulk Renamer'
    ]
  },
  convert: {
    title: 'Convert',
