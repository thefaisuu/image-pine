...
export const routeMap = {
  ...
  // Phase 4 tools
  'Palette Swapper': '/palette-swapper',
  'Social Media Cropper': '/social-crop',
  'Image Vectorizer': '/vectorizer',
  'Animation Studio': '/animation-studio',
  'Sticker & Mask Studio': '/sticker-studio',
};
...
export const navbarSections = {
  ...
  pdf: {
    title: 'PDF Tools',
    items: ['PDF to Images', 'Image to PDF', 'JPG to PDF', 'PNG to PDF', 'Compress PDF']
  },
  creative: {
    title: 'Creative',
    items: [
      'Collage Maker', 'Photo Filters', 'Image Watermarker', 'Meme Generator', 
      'Drawing Markup', 'Pixel Art Generator', 'QR Code Generator',
      'Palette Swapper', 'Sticker & Mask Studio'
    ]
  },
  more: {
    title: 'Utilities',
    items: [
      'Rotate Image', 'Flip Image', 'EXIF Metadata Stripper', 
      'SVG Rasterizer', 'GIF Maker', 'Palette Extractor', 
      'Image OCR Extractor', 'Bulk Renamer', 'SVG Optimizer',
      'Social Media Cropper', 'Image Vectorizer', 'Animation Studio'
    ]
  }
};
...
export const footerColumns = {
  ...
  studioTools: {
    ...
    items: [
      ...
      'Meme Generator', 'Drawing Markup', 'Palette Extractor',
      'Image OCR Extractor', 'Bulk Renamer', 'EXIF Metadata Stripper', 
      'SVG Rasterizer', 'GIF Maker', 'QR Code Generator', 'SVG Optimizer',
      'Pixel Art Generator', 'Palette Swapper', 'Social Media Cropper',
      'Image Vectorizer', 'Animation Studio', 'Sticker & Mask Studio'
    ]
  },
  convert: {
    title: 'Convert',
  ...
  pdfTools: {
    title: 'PDF Tools',
    items: [
      'Compress PDF', 'Image to PDF', 'JPG to PDF', 
