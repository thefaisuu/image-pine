...
export const navbarSections = {
  ...
  pdf: {
    title: 'PDF Tools',
    items: ['Add or Remove PDF Pages', 'PDF to Images', 'Image to PDF', 'JPG to PDF', 'PNG to PDF', 'Compress PDF']
  },
  creative: {
    title: 'Creative',
    items: [
...
export const footerColumns = {
  ...
  pdfTools: {
    title: 'PDF Tools',
    items: [
      'Add or Remove PDF Pages', 'Compress PDF', 'Image to PDF', 'JPG to PDF', 
