...
export const navbarSections = {
  ...
  creative: {
    ...
    items: [
      ...
      'Pixel Art Generator', 'QR & ISBN Generator', 'Device Mockup Studio', 
      'Object Eraser'
    ]
  },
  more: {
    ...
    items: [
      ...
      'Image OCR Extractor', 'Bulk Renamer', 'Contrast Checker'
    ]
  }
};
...
export const footerColumns = {
  ...
  studioTools: {
    ...
    items: [
      ...
      'Pixel Art Generator', 'Device Mockup Studio', 'Object Eraser', 
      'Contrast Checker'
    ]
  },
  convert: {
