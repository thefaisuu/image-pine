...
export const navbarSections = {
  ...
  convert: {
    title: 'Convert',
    items: [
      'Image Converter', 'SVG Converter', 'JPG Converter', 
  ...
  pdf: {
    title: 'PDF Tools',
    items: ['Compress PDF', 'Image to PDF', 'JPG to PDF', 'PNG to PDF', 'Add or Remove PDF Pages']
  },
  creative: {
    title: 'Creative',
    items: [
...
export const footerColumns = {
  ...
  convert: {
    ...
    items: [
      ...
      'PDF to PNG', 'PNG to SVG', 'WebP to JPG', 'PNG to JPG',
